# -*- coding: utf-8 -*-
"""
Created on Fri Aug 21 20:30:53 2020
...
for i in range(Ncorridas):
    ...
    name=(f"matmul_dispersa_corrida{i}.txt") #creo los archivos corresponden a cada corrida que seran lineas grises
    ...
    for N in Ns:
        ...
        B_lil=matriz_laplaciana_dispersa(N)
